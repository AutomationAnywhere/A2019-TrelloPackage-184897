...
public final class DeleteBoardCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DeleteBoardCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DeleteBoard command = new DeleteBoard();
    ...
    try {
      command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("name"));Optional<Value> result = Optional.empty();
